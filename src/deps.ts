export { Controller, Get, Area, App, container, instanceCachingFactory, Injectable, Inject } from 'https://deno.land/x/alosaur/mod.ts';
...
export { createClient, EventHandlers, Message, Intents } from 'https://raw.githubusercontent.com/Skillz4Killz/Discordeno/v5/mod.ts';
